...
public class OperationFactoryTest {
    ...
    public void  should_return_AddOperation_object_when_operator_is_add(){
        ...
        //verify that the operation object is an instance of AddOperation class (depends on the library we use)
    ...
    public void  should_return_SubOperation_object_when_operator_is_sub(){
        ...
        //verify that the operation object is an instance of SubOperation class (depends on the library we use)
    ...
    public void  should_return_MulOperation_object_when_operator_is_mul(){
        ...
        //verify that the operation object is an instance of MulOperation class (depends on the library we use)
    ...
    public void  should_return_DivOperation_object_when_operator_is_div(){
        ...
        //verify that the operation object is an instance of DivOperation class (depends on the library we use)
